  ...
  <div class="app-container">
    <div class="filter-container">
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        ...
        <el-form-item>
          <span class="title-text">实时新闻管理</span>
        </el-form-item>
        <el-form-item>
...
export default {
  ...
  methods: {
    ...
    uploadImage(file) {
      ...
      return this.api({
        url: '/village/actualtime/uploadImage',
        method: 'post',
        data: formData,
        headers: {
