  ...
  <div class="app-container">
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column label="主体类型名称" prop="typeName" align="center" />
      ...
      <!-- 添加或修改对话框 -->
      <el-dialog
        :title="dialogType === 'create' ? '新增驿站类型' : '编辑驿站类型'"
...
import {
  ...
  deleteSubjectType,
  updateStatus
} from '@/api/elderlyCare/subjectType'
import Pagination from '@/components/Pagination'

export default {
  name: 'ElderlySubjectType',
  ...
  methods: {
    ...
    handleDelete(row, index) {
      this.$confirm('确认删除该驿站类型吗？', '提示', {
        confirmButtonText: '确认',
        cancelButtonText: '取消',
        type: 'warning'
      }).then(async() => {
        await deleteSubjectType(row.id)
        this.$message({
          message: '删除成功',
          type: 'success'
        })
    ...
    handleModifyStatus(row, status) {
      ...
      this.$confirm(`确认${action}该驿站类型吗？`, '提示', {
        confirmButtonText: '确认',
        cancelButtonText: '取消',
        type: 'warning'
      }).then(async() => {
